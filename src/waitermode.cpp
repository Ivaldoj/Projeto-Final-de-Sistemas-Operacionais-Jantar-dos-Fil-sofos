...
namespace {
    ...
    const int ROUNDS = 200;      // número fixo de rodadas por filósofo
    ...
    void philosopherLife(int id) {
        for (int count = 0; count < ROUNDS; count++) {
            // marca início da espera assim que decide comer
            ...
            // marca fim da espera ao realmente conseguir os garfos
